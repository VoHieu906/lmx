// import type { Course, CourseWithProgressWithCategory } from '$lib/type';
...
// 			.collection('courses')
// 			.getFullList<Course>({
// 				filter: `isPublished = ${true} && title ?~ "${title}"  && category = "${categoryId}" chapters(course).isPublished = ${true}`,
